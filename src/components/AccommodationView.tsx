...
const accommodationColors: Record<string, string> = {
  Sandi: "bg-chart-1/10 border-chart-1/20 text-chart-1",
  Aconchego: "bg-chart-2/10 border-chart-2/20 text-chart-2",
  "Vila Bom jardim": "bg-chart-3/10 border-chart-3/20 text-chart-3",
  Bartholomeu: "bg-chart-4/10 border-chart-4/20 text-chart-4",
  "Barco próprio": "bg-chart-5/10 border-chart-5/20 text-chart-5",
  "Pousada Literária": "bg-primary/10 border-primary/20 text-primary",
};
    ...
    <div className="space-y-4 pb-20">
      <header className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Distribuição dos convidados confirmados
        </p>
      </header>
